...
def find_calib_files_for_datafile(data_fname, verbose=False):
    ...
    out = {
        ...
        "first_frame_time": t0,
        "dark": find_latest_file_before_time("/data/dark/dark_2D_*.npy", t0, verbose=verbose),
        "filter8": find_latest_file_before_time("/data/dark/filter_8_*.npy", t0, verbose=verbose),
        "gain": find_latest_file_before_time("/data/gain/gain_*.npy", t0, verbose=verbose),
        "filter": find_latest_file_before_time("/data/gain/filter_*.npy", t0, verbose=verbose),
    }
    return out